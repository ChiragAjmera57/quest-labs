export function getUserPointsAndLevel() {
    const url = `https://staging.questprotocol.xyz/api/entities/e-0000000000/users/u-a2399489-9cd0-4c94-ad12-568379202b08/xp`;
    const headers = {
